...
LOGIN --> USER CHOOSES ROLE (ADMIN, TEACHER, STUDENT) --> ACCOUNT CREATED; USER GRANTED ACCESS TO APP --> ROLE ACCESSES SPECIFIC PAGE (STUDENT, RECORD, ADMIN PAGE)
